System.config({
  ...
  "bundles": {
    "dist/app-build.js": [
      ...
      "src/aboutus/aboutus.html!github:systemjs/plugin-text@0.0.4",
      "src/aboutus/aboutus.js",
      "src/aboutus/history/history.html!github:systemjs/plugin-text@0.0.4",
      "src/aboutus/history/history.js",
      "src/aboutus/mission/mission.html!github:systemjs/plugin-text@0.0.4",
      "src/aboutus/mission/mission.js",
      "src/chicagoVeg.html!github:systemjs/plugin-text@0.0.4",
      "src/chicagoVeg.js",
      "src/classifications/classifications.html!github:systemjs/plugin-text@0.0.4",
      "src/classifications/classifications.js",
      "src/contact/capchaVerification.js",
      "src/contact/contact.html!github:systemjs/plugin-text@0.0.4",
      "src/contact/contact.js",
      "src/contact/recaptcha.html!github:systemjs/plugin-text@0.0.4",
      "src/cooking/cooking.html!github:systemjs/plugin-text@0.0.4",
      "src/cooking/cooking.js",
      "src/donate/donate.html!github:systemjs/plugin-text@0.0.4",
      "src/donate/donate.js",
      "src/family-kids/family-kids.html!github:systemjs/plugin-text@0.0.4",
      "src/family-kids/family-kids.js",
      "src/footer/footer.html!github:systemjs/plugin-text@0.0.4",
      "src/footer/footer.js",
      "src/history/history.html!github:systemjs/plugin-text@0.0.4",
      "src/history/history.js",
      "src/home/home.html!github:systemjs/plugin-text@0.0.4",
      "src/home/home.js",
      "src/main.js",
      "src/mission/mission.html!github:systemjs/plugin-text@0.0.4",
      "src/mission/mission.js",
      "src/nav-bar/nav-bar.html!github:systemjs/plugin-text@0.0.4",
      "src/nav-bar/nav-bar.js",
      "src/nav-bar/setup-dropdown.html!github:systemjs/plugin-text@0.0.4",
      "src/nav-bar/setup-dropdown.js",
      "src/news/news.html!github:systemjs/plugin-text@0.0.4",
      "src/news/news.js",
      "src/outreach/outreach.html!github:systemjs/plugin-text@0.0.4",
      "src/outreach/outreach.js",
      "src/programs/programs.html!github:systemjs/plugin-text@0.0.4",
      "src/programs/programs.js",
      "src/resources/resources.html!github:systemjs/plugin-text@0.0.4",
      "src/resources/resources.js",
      "src/restaurants/restaurants.html!github:systemjs/plugin-text@0.0.4",
      "src/restaurants/restaurants.js",
      "src/singles/singles.html!github:systemjs/plugin-text@0.0.4",
      "src/singles/singles.js",
      "src/social-media-area/facebooklike.html!github:systemjs/plugin-text@0.0.4",
      "src/social-media-area/facebooklike.js",
      "src/social-media-area/social-media-area.html!github:systemjs/plugin-text@0.0.4",
      "src/social-media-area/social-media-area.js",
      "src/social-media-area/socialmedia.js",
      "src/sponsors/sponsors.html!github:systemjs/plugin-text@0.0.4",
    ...
    "dist/vendor-build.js": [
      ...
      "npm:babel-runtime@5.8.35/helpers/create-decorated-class",
      "npm:babel-runtime@5.8.35/helpers/define-decorated-property-descriptor",
      "npm:bluebird@3.2.2",
      "npm:bluebird@3.2.2/js/browser/bluebird",
      "npm:core-js@1.2.6",
      ...
      "npm:font-awesome@4.5.0/fonts/FontAwesome.otf!github:systemjs/plugin-text@0.0.4",
      "npm:font-awesome@4.5.0/fonts/fontawesome-webfont.eot!github:systemjs/plugin-text@0.0.4",
      "npm:font-awesome@4.5.0/fonts/fontawesome-webfont.svg!github:systemjs/plugin-text@0.0.4",
      "npm:font-awesome@4.5.0/fonts/fontawesome-webfont.ttf!github:systemjs/plugin-text@0.0.4",
      "npm:font-awesome@4.5.0/fonts/fontawesome-webfont.woff!github:systemjs/plugin-text@0.0.4",
      "npm:font-awesome@4.5.0/fonts/fontawesome-webfont.woff2!github:systemjs/plugin-text@0.0.4",
      "npm:process@0.11.2",
